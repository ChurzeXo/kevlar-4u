...
Kevlar-4u 是一个「评论区模拟器」——把你的文案交给多个独立 AI 评审员，每个人设从不同视角给出犀利的评审意见，帮你发帖前发现潜在问题。
...
**开始一次评测**
直接把你的文案/帖子/剧本发给我，我会先列出当前可用的评审员，你勾选想激活的角色（默认全部选中），然后开始评测。
...
**Q: 自定义评审员可以分享吗？**
可以。评审员文件存储在项目目录的 skills 文件夹中，分享文件给对方即可。
